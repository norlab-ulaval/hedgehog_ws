...
def generate_launch_description():
    ...
    robot_description_urdf = os.path.join(
        get_package_share_directory("hedgehog_system"), "urdf", "hedgehog_description.urdf"
    )
    ...
    robot_state_publisher_node = Node(
        ...
        parameters=[{"robot_description": robot_description_content}, LaunchConfiguration("use_sim_time")],
    )
